        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/offers" className="text-spa-ink/50 text-sm hover:text-emerald-600 transition-colors">Offers</Link></li>
              <li><Link to="/products" className="text-spa-ink/50 text-sm hover:text-emerald-600 transition-colors">Products</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+16475076081" className="text-spa-ink/50 text-sm hover:text-emerald-600 transition-colors">
                  (647) 507-6081
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail size={16} className="text-emerald-600 shrink-0" />
                <a href="mailto:rdharmonymedspa@gmail.com" className="text-spa-ink/50 text-sm hover:text-emerald-600 transition-colors">
                  rdharmonymedspa@gmail.com
                </a>
              </li>
            </ul>
          </div>
