...
export const SERVICES: Service[] = [
    ...
    options: [
      {
        ...
        price: '$149',
        duration: '45 Minutes',
        description: 'Deep cleansing, exfoliation, extractions, hydration, and a customized mask.',
      },
      {
        id: 'delux',
        name: 'Delux HydraFacial',
        price: '$199',
        duration: '60 Minutes',
        description: 'Deep cleansing, exfoliation, extractions, gentle peel, customized booster, hydration, lymphatic drainage, décolleté treatment, neck and shoulder massage, and LED light therapy.',
      },
    ],
  ...
  },
  {
    ...
    options: [
      {
        id: 'signature',
        name: 'Signature Microdermabrasion',
        price: '$149',
        description: 'Deep cleansing, exfoliation, extractions, gentle peel, customized booster, hydration, facial massage.',
      },
      {
        id: 'delux',
        name: 'Delux Microdermabrasion',
        price: '$199',
        description: 'Deep cleansing, exfoliation, extractions, gentle peel, customized booster, hydration, lymphatic drainage, décolleté, neck and shoulder massage, and LED therapy.',
      },
    ],
  ...
  },
  {
    ...
    category: 'Skincare',
    isMobileAvailable: false,
    image: '/images/facial_detail.jpg',
    description: 'A brightening facial designed to revitalize dull skin and restore your natural glow.'
  },
  {
    ...
    isMobileAvailable: false,
    image: '/images/skin_care_clinical.jpg',
    description: 'An advanced facial treatment targeting fine lines, wrinkles, and loss of elasticity for a youthful appearance.'
  },
  {
    id: 'tripolar-radiofrequency',
    name: 'Tripolar radiofrequency skin tightening',
    duration: '60 Minutes',
    price: '$149',
    category: 'Skincare',
    isMobileAvailable: false,
  ...
  },
  {
    ...
    name: 'Lifting stone facial',
    duration: '60 Minutes',
    price: '$129',
    category: 'Skincare',
    isMobileAvailable: false,
    image: '/images/spa_env.jpg',
    description: 'A rejuvenating facial that uses lifting stones to massage, contour, and lift facial muscles for a refreshed look.'
  },
  {
  ...
  {
    id: 'prp-hair',
    name: 'Platelet-Rich Plasma (PRP) for Hair Restoration',
  ...
  },
  {
    ...
    name: 'SkinPen Microneedling with Booster',
  ...
  {
    id: 'vivier-peel',
    name: 'Vivier Chemical Peel',
    duration: '30 Minutes',
    price: '$99',
    category: 'Skincare',
    isMobileAvailable: false,
    image: '/images/facial_chemical_peel.jpg',
    description: 'A gentle yet effective professional peel that helps refresh, brighten, tighten and illuminate the appearance of the skin. Ideal for aging skin, age spots, dehydrated skin, skin imperfections, oily skin, congested skin and acne-prone skin. Beautiful results with no downtime.',
    longDescription: 'The Vivier Peel is ideal for aging skin, dark spots, dehydrated skin, skin imperfections, and oily, congested acne-prone skin. Gentle yet effective, it helps refresh, brighten, tighten, and illuminate the appearance of the skin. It contains 10% lactic acid, 2% salicylic acid, 14% resorcinol, peptides and panthenol. We typically suggest this peel if you are a first-timer looking for an overall skin rejuvenation. The treatment takes about 30 minutes and is not painful; some clients experience a slight tingling as it activates the skin. Typically there is no downtime, though some experience redness and flaking for up to 5 days. Post-treatment kits with Vivier products are provided to support recovery.',
  },
  {
    id: 'vivier-jessner-plus',
    name: 'Vivier TX Jessner Plus',
    duration: '30 Minutes',
    price: '$119',
    category: 'Skincare',
    isMobileAvailable: false,
    image: '/images/facial_chemical_peel.jpg',
    description: 'An advanced-strength professional resurfacing peel that safely provides controlled exfoliation of damaged skin. Ideal for aging skin, age spots, acne-prone skin, enlarged pores, post-inflammatory hyperpigmentation, and dull, lacklustre complexion. Quickly improve your skin’s health and appearance with minimal downtime.',
    longDescription: 'The Vivier TX Jessner Plus is suitable for aging skin, age spots, enlarged pores and a dull complexion. This resurfacing peel balances quick results with minimal downtime, reducing the appearance of fine lines and age spots for firmer, tighter skin with a more youthful glow. It is our more advanced peel, with the same ingredients as the Vivier Peel but at higher concentrations: 14% lactic acid, 14% salicylic acid, 14% resorcinol, peptides and panthenol. 14% Lactic Acid firms and thickens skin to reduce fine lines while keeping it hydrated; 14% Salicylic Acid reduces acne-related swelling and redness and unclogs pores; 14% Resorcinol disinfects the skin and stimulates collagen production. As with all treatments, a personal consult is performed prior to treatment to determine the most appropriate peel for your skin type.',
  },
  {
    id: 'prp-skinpen-microneedling',
    name: 'Platelet-Rich Plasma (PRP) with SkinPen Microneedling',
    duration: '60 Minutes',
    price: '$419',
    category: 'Medical',
    isMobileAvailable: false,
    image: '/images/svc_prp_face.jpg',
    description: 'Platelet-Rich Plasma (PRP) combined with SkinPen microneedling to boost collagen production and skin regeneration using your body’s own growth factors for smoother, firmer, more radiant skin.',
  },
  {
    id: 'laser-small-area',
    ...
    description: 'A small area includes any one of the following treatment areas: chin, upper lip, nose, sideburns, cheeks, fingers, toes, between eyebrows, tummy trail, forehead, areolas.',
  },
  {
    id: 'laser-medium-area',
    ...
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'A medium area includes any one of the following treatment areas: half face, front of neck, back of neck, underarms, shoulders, lower arms, bikini line, lower back, perineum.',
  },
  {
    id: 'laser-medium-plus-area',
    name: 'Laser Hair Removal – Medium Plus Area',
    duration: 'Varies',
    price: '$60',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'A medium plus area can include any one of the following areas: full face (with forehead), full front bikini, upper arms, chest, abdomen, butt cheeks, upper back.',
  },
  {
    id: 'laser-large-area',
    ...
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'A large area can include any one of the following areas: full arms, face with neck, scalp, Brazilian, lower legs, upper legs, butt cheeks (inc. perineum).',
  },
  {
    id: 'laser-xl-area',
    ...
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'An extra large area can include any one of the following areas: full legs, or full back.',
  },
  {
    id: 'laser-facial-tip',
    name: 'Laser Facial Tip (Eyebrows, Ears or Hairline)',
    duration: 'Varies',
    price: '$50',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'Delicate areas deserve a different kind of care. We use the Soprano Facial Tip — a specialized handpiece designed to safely and precisely treat small, hard-to-reach facial areas with the same power and performance as our full-body laser technology. Also great for beard sculpting. Add to any treatment for $50.',
  },
  {
    id: 'laser-any-4-areas',
    name: 'Laser Hair Removal – Any 4 Areas',
    duration: 'Varies',
    price: '$140',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'Choose any 4 areas to be completed in the same laser session: chin, upper lip, ears, neck (front or back), underarms, shoulders, upper arms, lower arms, hands, chest, abdomen, upper or lower back, bikini, buttocks, perineum, upper or lower legs, feet. Excludes full legs & full back ($10 more).',
  },
  {
    id: 'laser-any-5-areas',
    name: 'Laser Hair Removal – Any 5 Areas',
    duration: 'Varies',
    price: '$170',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'Choose any 5 areas to be completed in the same session: face, ears, front of neck, back of neck, underarms, shoulders, upper arms, lower arms, hands, chest, abdomen, upper back, lower back, bikini, buttocks, perineum, upper legs, lower legs, feet.',
  },
  {
    id: 'laser-any-6-areas',
    name: 'Laser Hair Removal – Any 6 Areas',
    duration: 'Varies',
    price: '$190',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'Choose any 6 areas to be completed in the same session: face, ears, front of neck, back of neck, underarms, shoulders, upper arms, lower arms, hands, chest, abdomen, upper back, lower back, bikini, buttocks, perineum, upper legs, lower legs, feet.',
  },
  {
    id: 'laser-underarms-brazilian',
    name: 'Laser Hair Removal – Underarms & Brazilian',
    duration: 'Varies',
    price: '$100',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'Reveal smoother, low-maintenance skin with Underarms and Brazilian laser hair removal. Treatments are personalized for comfort, precision, and beautifully smooth results. Upgrade to full face for $40 more.',
  },
  {
    id: 'laser-modern-man',
    name: 'Laser Hair Removal – "Modern Man" Bundle',
    duration: 'Varies',
    price: '$240',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'Includes: front of neck, back of neck, underarms, chest, abdomen, shoulders, upper back & lower back. (Reg. $535.)',
  },
  {
    id: 'laser-essentials-full-body',
    name: 'Laser Hair Removal – "Essentials" Full Body Bundle',
    duration: 'Varies',
    price: '$225',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'Treatment areas include full arms, underarms, bikini line, full legs & feet. Upgrade to Brazilian for $30 more.',
  },
  {
    id: 'laser-womens-head-to-toe-ex-face',
    name: 'Women’s "Head to Toe" Full Body (Excludes Face & Neck)',
    duration: 'Varies',
    price: '$275',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'Imagine never having to shave, wax, or schedule last-minute touch-ups again. With full body laser hair removal at RD Harmony Med Spa you can enjoy long-term smoothness, glowing skin, and confidence from head to toe. Excludes face & neck.',
  },
  {
    id: 'laser-womens-head-to-toe',
    name: 'Women’s "Head to Toe" Full Body',
    duration: 'Varies',
    price: '$350',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'Our full body laser treatments are designed for women who want complete, worry-free hair reduction — customized to their skin tone, hair type, and personal goals. From legs to bikini, arms to face, every session is performed with expert care using the most advanced laser technology available.',
  },
  {
    id: 'laser-womens-head-to-toe-pkg4',
    name: 'Women’s "Head to Toe" Full Body – Package of 4 Sessions',
    duration: 'Varies',
    price: '$1300',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'Package of 4 sessions. Enjoy long-term smoothness, glowing skin, and confidence from head to toe with full body laser hair removal at RD Harmony Med Spa.',
  },
  {
    id: 'laser-mens-head-to-toe',
    name: 'Male "Head to Toe" Full Body',
    duration: 'Varies',
    price: '$400',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'Whether it’s for performance, personal comfort, or a polished appearance, full body laser hair removal is an effective, low-maintenance option for men. From back and chest to arms, legs, and beyond — we’ll customize a treatment plan that fits your needs, your hair type, and your lifestyle.',
  },
  {
    id: 'laser-mens-head-to-toe-pkg4',
    name: 'Male "Head to Toe" Full Body – Package of 4 Sessions',
    duration: 'Varies',
    price: '$1400',
    category: 'Laser Hair Removal',
    isMobileAvailable: false,
    image: '/images/laser_waxing.jpg',
    description: 'Package of 4 sessions. Full body laser hair removal for men — from back and chest to arms, legs, and beyond, customized to your needs, hair type, and lifestyle.',
  },
];
